...
var (
	...
	deviceVFIOString               = "-device vfio-pci,host=02:10.0,x-fixed-bars=on,x-fixed-bars-allow-32bit-fallback=on,x-pci-vendor-id=0x1234,x-pci-device-id=0x5678,romfile=efi-virtio.rom"
