...
var (
	...
	deviceVFIOString               = "-device vfio-pci,host=02:10.0,x-pci-vendor-id=0x1234,x-pci-device-id=0x5678,rombar=0,romfile=efi-virtio.rom"
	...
	deviceVFIOPCIeSimpleString     = "-device vfio-pci,host=02:00.0,rombar=0,bus=rp0"
	deviceVFIOPCIeFullString       = "-device vfio-pci,host=02:00.0,x-pci-vendor-id=0x10de,x-pci-device-id=0x15f8,rombar=0,romfile=efi-virtio.rom,bus=rp1"
